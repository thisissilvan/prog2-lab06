...
import ch.zhaw.prog2.functional.streaming.finance.CurrencySupplier;
...
public class EmployeeSupplier implements Supplier<Employee> {
    ...
    public EmployeeSupplier(Random random) {
        ...
        accountSupplier = new BankAccountSupplier(random);
    }
    ...
    public Employee get() {
        ...
        Employee newEmployee = new Employee(selectOne(FIRSTNAMES), selectOne(LASTNAMES))
            ...
            .setYearlySalary(new CurrencyAmount(random.nextInt(SALARY_MAX), currencySupplier.get()))
